...
class SKPaginationView: UIView {
    ...
    private var margin: CGFloat = SKButtonOptions.closeButtonPadding.y //20
    private var extraMargin: CGFloat = 0 //SKMesurement.isPhoneX ? 40 : 0
    fileprivate let labelSize: CGSize = CGSize(width: 100, height: 60) // equal to button size
    ...
    convenience init(frame: CGRect, browser: SKPhotoBrowser?) {
        ...
        self.frame = CGRect(x: 0, y: margin + extraMargin, width: frame.width, height: 100)
...
private extension SKPaginationView {
    ...
    func setupCounterLabel() {
        ...
        label.center = CGPoint(x: frame.width / 2, y: labelSize.height / 2) //frame.height / 2)
